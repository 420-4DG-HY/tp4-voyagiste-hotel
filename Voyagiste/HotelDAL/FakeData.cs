...
namespace HotelDAL
{
    public class FakeData
    {
        ...
        new HotelBooking(new Guid("d3062793-8a01-4e8a-beba-2db3a9cf0871"), rooms[0], guests[0], new DateTime(2022, 5, 11)),
        new HotelBooking(new Guid("c901d3e7-17ee-44f8-8787-842a5e72184f"), rooms[1], guests[1], new DateTime(2023, 10, 12)),
        new HotelBooking(new Guid("52b54352-7415-4723-bc11-5caebaba9f8c"), rooms[2], guests[3], new DateTime(2024, 12, 13))
        };
            #endregion
        private FakeData()
        {
