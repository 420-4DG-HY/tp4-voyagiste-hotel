...
namespace HotelDAL
{
    ...
    public class HotelDataAccess : IHotalDataAccess
    {
        ...
        public HotelBooking[] GetHotelBookings(Hotel hotel)
        {
            //Back-up -> return FakeData.GetInstance().hotelBookings.Where(hb => hb.Hotel == hotel).ToArray();
            return FakeData.GetInstance().hotelBookings.Where(hb => hb.HotelBookingId == hotel.).ToArray();
        }
        ...
        public HotelAvailability[] GetHotelAvailabilities(Hotel hotel)
        {
            return FakeData.GetInstance().hotelAvailabilities.Where(ha => ha.Hotel == Hotel).ToArray();
        }
